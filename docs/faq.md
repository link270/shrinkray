...
### 1. Why is CPU usage 10-40% with hardware encoding?
...
### 2. How can I tell if I'm using my GPU for transcoding?
...
### 3. What hardware supports AV1 encoding?
...
### 4. Intel Quick Sync (QSV) not working on non-Unraid systems?
...
### 5. Why does my AMD GPU show 0% usage during hardware encoding?
...
### 6. Why did Shrinkray skip some files?
...
### 7. What happens if the transcoded file is larger?
...
### 9. Are multiple audio tracks preserved?
...
### 11. How does Shrinkray compare to Tdarr/Unmanic?
...
### 12. Can I use RAM (/dev/shm) for temp files?

Yes. Map `/dev/shm` (or any RAM disk) to the `/temp` container path.

### 13. Can I customize FFmpeg settings or create custom presets?
...
### 14. Can Shrinkray transcode audio?
